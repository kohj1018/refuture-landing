                ...
                <div className="bg-gray-50 rounded-2xl p-6 shadow-sm">
                    ...
                    <div className="mt-6">
                        <div className="w-full bg-gray-200 rounded-full h-5 relative overflow-hidden">
                            <div className="bg-indigo-500 h-5 rounded-l-full" style={{ width: `${progressPercentage}%` }}></div>
                            <div className="absolute inset-0 flex items-center justify-center text-xs font-bold text-white">
                                예상 금액: {formatMoney(data.estimatedAmount)}
                            </div>
                        </div>
                        <div className="text-right text-sm font-bold text-gray-700 mt-1">목표: {formatMoney(data.goalAmount)}</div>
                    </div>
                </div>
